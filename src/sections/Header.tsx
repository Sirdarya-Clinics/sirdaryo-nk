...
export function Header2() {
  ...
  const [useLang, setLang] = useState({
    header:
      "Respublika ixtisoslashtirilgan narkologiya ilmiy amaliy tibbiyot markazi Sirdaryo viloyat mintaqaviy filiali",
    about: "Biz haqimizda",
  ...
  useEffect(() => {
    if (lang === "/ru") {
      setLang({
        header:
          "Республиканский специализированный наркологический научно-практический медицинский центр, областной филиал Сырдарьинской области",
        about: "О нас",
      ...
      setLang({
        header:
          "Republican specialized narcology scientific and practical medical center, regional branch of Syrdarya region",
        about: "About Us",
        open_data: "Open data",
        contact: "Contacts",
        address: "Address",
